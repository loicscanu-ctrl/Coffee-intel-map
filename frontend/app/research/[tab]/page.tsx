...
const VALID_TABS = ["cot", "signals", "sentiment", "futures", "macro", "weather", "supply", "farmer", "fertilizer", "contracts", "delivery", "agronomy", "logistics", "destination", "freight", "certstocks", "parity", "demand"] as const;
