...
const VALID_TABS = ["cot", "signals", "sentiment", "futures", "macro", "weather", "supply", "farmer", "fertilizer", "contracts", "agronomy", "logistics", "destination", "freight", "certstocks", "demand"] as const;
