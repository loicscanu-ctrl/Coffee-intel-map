...
interface RobustaJson {
  ...
  // Workbook full-history per-port rollup (Nov 2023 → present). Lets the
  // panel infer the origin mix of old standing stock graded outside the
  // rolling daily window (e.g. Felixstowe's 34 lots at ~23 months old).
