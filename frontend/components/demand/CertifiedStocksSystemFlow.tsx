...
import {
  type DensitySquare, type OriginFlowPair, type OriginFlow,
  type PortFlow, type RobustaPortSim,
  type RobustaSnap, type RobustaGradingEvent,
} from "@/lib/certifiedStocks/types";
import { _computePoison } from "@/lib/certifiedStocks/poison";
import { _simulateRobustaPortStock } from "@/lib/certifiedStocks/sim";
import {
  BAGS_PER_WARRANT_KC, LOTS_PER_WARRANT_RC,
  CLASS_BORDER_RC, CLASS_LABEL_RC, CELL_PX_KC, CELL_PX_RC,
  _gridCols, _rowsForCount, buildDensityGrid, _assignSpans,
