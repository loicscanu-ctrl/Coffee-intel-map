...
import {
  CountryYear, CoffeeType, ViewMode, DestWindow,
  HUB_COLORS, HUB_ORDER, SLATE, GREEN,
  TT_STYLE, TYPE_LABELS, DEST_WINDOWS, EMPTY_CY,
  bagsToKT, monthLabel, cropYearKey, offsetYM, toEn, getHub,
} from "./brazilTypes";
...
export function DestinationChart({
  ...
  // Suppress unused warning — currentYear is available for future use in period labels
  void currentYear;
