...
export default function HondurasExportPanel({ exports: exp }: { exports: ExportsData }) {
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-4 border border-slate-700 space-y-3">
      ...
      <div className="h-40">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData} margin={{ top: 2, right: 36, left: -10, bottom: 0 }}>
            ...
            />
            <Bar  yAxisId="vol" dataKey="mt"  name="vol" fill="#10b981" opacity={0.8} radius={[2,2,0,0]} />
      ...
      <div className="text-[9px] text-slate-600">
        Source: ICO Historical CSV — Green coffee exports, {exp.unit}. Honduras: largest arabica producer in Central America.
      </div>
    </div>
  );
}
