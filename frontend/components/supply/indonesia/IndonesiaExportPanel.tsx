...
export default function IndonesiaExportPanel({ exports: exp }: { exports: ExportsData }) {
    ...
    <div className="bg-slate-800 rounded-lg p-4 border border-slate-700 space-y-3">
      <div className="flex items-baseline justify-between">
        <div className="text-[10px] text-slate-400 uppercase tracking-wide">
          Indonesia Green Coffee Exports
        </div>
      ...
      <div className="h-40">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData} margin={{ top: 2, right: 36, left: -10, bottom: 0 }}>
            ...
            />
            <Bar  yAxisId="vol" dataKey="mt"  name="vol" fill="#8b5cf6" opacity={0.8} radius={[2,2,0,0]} />
      ...
      <div className="text-[9px] text-slate-600">
        ...
        Indonesia: world&apos;s 4th largest producer (~75% robusta).
      </div>
    </div>
  );
}
